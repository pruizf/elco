...
EVALUATOR="/home/pablo/projects/el/eval/neleval/nel"
PREFIX=/home/pablo/projects/el/el1/combine/newout/indiv_wf_length
MAP="/home/pablo/projects/el/el1/eval/gold/map-all-uniq"
SUFFIXOLD=mapped
SUFFIX=mapped4
...
EVALU=eval_${CORPUS}_${RUN}_ONEMAP


if [ $CORPUS = conll ] ; then
    GOLD="/home/pablo/projects/el/el1/eval/gold/conll_gold_nel.${SUFFIXOLD}"
    CORPUS=CoNLL
elif [ $CORPUS = aquaint ]; then
    GOLD="/home/pablo/projects/el/el1/eval/gold/aquaint_gold_nel.${SUFFIXOLD}"
    CORPUS=AQUAINT
elif [ $CORPUS = msnbc ]; then
    GOLD="/home/pablo/projects/el/el1/eval/gold/msnbc_gold_nel.${SUFFIXOLD}"
    CORPUS=MSNBC
else
    GOLD="/home/pablo/projects/el/el1/eval/gold/iitb_gold_nel.${SUFFIXOLD}"
    CORPUS=IITB
fi
...
datanewdir=/home/pablo/bkp_results/data_${RUN}_${CORPUS}_ONEMAP
mkdir -p "$datanewdir"
